...
<body>
      ...
      <div class="row">
        <div class="table">
          <div class="table-body table-responsive">
            <table id="typeTable" class="display  table-hover table-bordered table-sm" cellspacing="0" width="100%">
              <thead>
                <tr>
                  <th>رقم نوع</th>
                  <th>اسم نوع</th>
  ...
  <div id="modalBackground" class="modal-background">
    <div id="modal" class="modal">
      ...
      <!-- Form -->
      <form id="saveTypeForm" class="form" method="post">
        <div class="row">
          <!-- Form fields -->
          <div class="full-width col-lg-12">
            <div class="input-field">
              <input placeholder="اسم نوع" type="text" class="input" name="typ_name" id="typ_name" autocomplete="off" autocapitalize="on" required />
            </div>
          </div>
          <div class="full-width col-lg-12">
            <div class="input-field">
              <input placeholder="وصف نوع" type="text" class="input" name="description" id="description" autocomplete="off" autocapitalize="on" required />
            </div>
            <div class="full-width col-lg-12">
              <div class="input-field">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      $("#typeTable").DataTable({
        ...
        'ajax': {
          'url': 'fetch_type_data.php',
          'type': 'post',
          'data': {}
        },

        'fnCreatedRow': function(nRow, aData, iDataIndex) {
          $(nRow).attr('TypeID', aData[0]);
        },
        'columnDefs': [{
          'targets': 3,
  ...
  <script type="text/javascript">
    $('#saveTypeForm').submit(function(event) {
