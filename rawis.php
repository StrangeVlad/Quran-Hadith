...
<body>
  ...
  <div class="content">
    ...
    <div class="wrapper">
      ...
      <button type="button" data-bs-toggle="#" data-bs-target="#modalBackground" id="addButton" class="button f-width notification add-reminder">أضف راوي جديد
      </button>
  ...
  <div id="modalBackground" class="modal-background">
    <div id="modal" class="modal">
      ...
      <!-- Form -->
      <form id="saveRawiForm" class="form" method="post">
        <div class="row">
          <!-- Form fields -->
          <div class="full-width col-lg-12">
            <div class="input-field">
              <input placeholder="اسم الراوي" type="text" class="input" name="name" id="name" autocomplete="off" autocapitalize="on" required />
            </div>
          </div>
          <div class="full-width col-lg-12">
            <div class="input-field">
              <input placeholder="الوصف" type="text" class="input" name="description" id="description" autocomplete="off" autocapitalize="on" required />
            </div>
          </div>
          <div class="full-width col-lg-12">
            <div class="input-field">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      $("#collectionTable").DataTable({
        ...
        'ajax': {
          'url': 'fetch_rawi_data.php',
          'type': 'post',
          'data': {}
        },

        'fnCreatedRow': function(nRow, aData, iDataIndex) {
          $(nRow).attr('RawiID', aData[0]);
        },
        'columnDefs': [{
          'targets': 3,
  ...
  <script type="text/javascript">
    $('#saveRawiForm').submit(function(event) {
